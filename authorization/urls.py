...
urlpatterns = [
    path('', cache_page(1)(views.home_page), name='home'),
    path('user/<int:user_id>', cache_page(1)(views.UserDetailsView.as_view()), name='user_page'),
    path('accounts/', include('django.contrib.auth.urls')),
    path('accounts/registration', views.RegistrationForm.as_view(), name='registration'),
    path('about', cache_page(1)(views.about_page), name='about'),
    ...
    path('articles/<int:article_id>', cache_page(1)(views.ArticleDetailsView.as_view()), name='article_page'),
